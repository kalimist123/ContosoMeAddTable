...
namespace ContosoUniversity.Data
{
    public static class DbInitializer
    {
        public static void Initialize(SchoolContext context)
        {
            ...
            var schoolsbooks = new SchoolBook[]
            {

                new SchoolBook {Author = "Mick", Price = 5, Name = "Great Stuff"},
                new SchoolBook {Author = "Peter", Price = 7, Name = "More Great Stuff"},
            };

            foreach (var book in schoolsbooks)
            {
                context.SchoolBooks.Add(book);
            }
            context.SaveChanges();
